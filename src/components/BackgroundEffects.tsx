  ...
  return (
    <div className="background-effects">
      ...
      <div
        ...
        style={{
          transform: `translate(${scrollY * 0.18}px, ${
            scrollY * 0.15
          }px) rotate(${scrollY * 0.18}deg)`,
        }}
      ></div>
      ...
      <div
        ...
        style={{
          transform: `translate(${scrollY * 0.12}px, ${
            scrollY * 0.22
          }px) scale(${1 + scrollY / 3000})`,
        }}
      ></div>
      <div
        ...
        style={{
          transform: `translate(${-scrollY * 0.18}px, ${
            scrollY * 0.28
          }px) scale(${1 + scrollY / 4000})`,
        }}
      ></div>
      <div
        className="animated-blob blob-3"
        style={{
          transform: `translate(${scrollY * 0.14}px, ${
            -scrollY * 0.12
          }px) scale(${1 + scrollY / 3500})`,
        }}
      ></div>
